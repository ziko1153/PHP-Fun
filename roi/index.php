...
<body>
    ...
    <div class="container shadow-sm border p-3 mb-5 bg-white rounded" id="page-two" style="display: none;">
        <div class="row" style="padding-right: 10px;">
            ...
            <div class="col-md-4 col-sm-4 border ">
                ...
                <div class="row">
                    <div class="col-12 from-group">
                        <input class="form-control shadow-sm" autocomplete="off" type="text" id="name"
                            placeholder="Name">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-12 from-group">
                        <input class="form-control shadow-sm" autocomplete="off" type="email" id="email"
                            placeholder="Email">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-12 from-group">
                        <input class="form-control shadow-sm" autocomplete="off" pattern="[1-9]{1}[0-9]{9}" type="text"
            ...
            if (name == "" || email == "" || mobile == "") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        window.open('roi.php?name=' + name + '&&email=' + email +
                            '&&mobile=' + mobile + '&&current_energy=' +
                            current_energy + '&&new_energy=' + new_energy +
                            '&&yearly_savings=' + yearly_savings + '&&property_add=' +
                            property_add + '&&type_property=' + type_property +
                            '&&ex_wat=' + ex_wat + '&&new_wat=' + new_wat +
                            '&&op_hours=' + op_hours + '&&op_days=' + op_days, '_blank');
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCp6nrI9Oyl_GrKUfoPHoFZK6-J1SKXOoQ&libraries=places&callback=findAddress"
        async defer></script>
</body>
