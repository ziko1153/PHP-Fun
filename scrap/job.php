...
if (isset($_POST['add_cron'])) {
    ...
    echo "<h1>For Demo  Disabled Cron JOB for save my Hosting hahahahah</h1>";
...
<div class="container box">
    <h2>Add or Remove Cron Job</h2>Please Change This Directory <h3>/home/<b
            style="color:red">username</b>/public_html/<b style="color:red">path/to/cron/script</b></h3>
</div>
<div class="container">
    <form class="form-horizontal" method="post" action="<?php $_SERVER['REQUEST_URI'];?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="text" name="add_cron" size="100"
                    placeholder="e.g.: 0 */2 * * * /usr/local/bin/php -q /home/username/public_html/cron.php">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="">Remove Cron:</label>
            <div class="col-sm-10">
                <input class="form-control" type="text" name="remove_cron" size="100"
                    placeholder="e.g.: 0 */2 * * * /usr/local/bin/php -q /home/username/public_html/cron.php">
            </div>
        </div>
        <div class="form-group">
