...
?>
			...
			<input  type="text" class="form-control" id="host" value="<?=$row['host'];?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input  type="text" class="form-control" id="smtp_secure" value="<?=$row['smtp_secure'];?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input  type="text" class="form-control" id="from_email" value="<?=$row['from_email'];?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input  type="text" class="form-control" id="reply_email" value="<?=$row['reply_email'];?>">
							</div>
							...
							<div class="col-sm-3">
								<input  type="text" class="form-control" id="reply_name" value="<?=$row['reply_name'];?>">
							</div>
						...
						<div class="form-group pull-left"> 
							<div style="margin-left: 230px;margin-top:20px;">
								<button id="update_email" type="submit" class="btn btn-success" name="update">Update</button>
		...
		<?php } } ?>
			...
			<div class="form-group">
						...
						<div class="form-group ">
							...
							<div class="col-sm-3">
								<input type="password" class="form-control passwordfield" id="new_pass" name="new_pass" value="">
						...
						<div class="form-group">
							...
							<div  class="col-sm-3">
								<input  type="password" class="form-control passwordfield" id="con_pass" name="con_pass" value="">
									
							
							</div class="col-sm-2">
								<button class= "btn btn-default reveal"><span class="glyphicon glyphicon-eye-open"></span></button>
							</div>
						...
						<div class="form-group pull-left"> 
							<div style="margin-left: 230px;">
								<button type="submit" class="btn btn-default btn-warning" id="user_pass_create">Create</button>
	...
	<div id="theme" class="tab-pane fade">
		<div class="">
				<marquee><h3 style="color: black;"><b>Theme Under Construction!!Get Next Update V.2.0 </b></h3></marquee>
			</div>
		</div>

			<div id="print" class="tab-pane fade">
				<marquee><h3 style="color: black;"><b> Print Under Construction!!Get Next Update  V.2.0  </b></h3></marquee>
		</div>

			<div id="database" class="tab-pane fade">
				<marquee><h3 style="color: black;"><b> Database Under Construction!!Get Next Update  V.2.0 .....</b></h3></marquee>
