...
<div class="container box">
    ...
    <h1 align="center">Extract Text From Image Using Goolge Cloud Vision API</h1>
    <br />
    <div class="table-responsive">
        ...
        <div align="right">
            ...
            <button class="btn btn-danger" id="dlt_selected_btn" style="display:none;"><span
        ...
        var interval = setInterval(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data >= 100) {
                        $('.progress-bar').width("100%").html(
                            'Sorry Disabled Image Extract');
    ...
    $('#multiple_files').change(function() {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            if (jQuery.inArray(ext, ['gif', 'png', 'jpg', 'jpeg']) == -1) {
                error_images += '<p> Please Check This Image : "<b style="color:blue">' + name +
                    '</b>" Invalid File Format</p>';
            }
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#error_multiple_files').html(
                        '<br /><label class="text-primary">Uploading...</label>');
                ...
                success: function(data) {
                    ...
                    if (res.code == "0") {
                        $('#error_multiple_files').html(
                            '<br /><label class="text-success">Successfully Uploaded</label>'
                        );
                        ...
                        $('#error_multiple_files').html(
                            '<br /><label class="text-danger">' + res.result +
                            '</label>');
                        $("#multiple_files").prop("disabled", false);
                        $('#multiple_files').val('');
                        dataTable.ajax.reload();
